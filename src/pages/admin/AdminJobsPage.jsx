          ...
          <tbody>
            {filtered.map((j) => (
              <tr key={j.id}>
                ...
                <td><div onClick={() => updateJob(j.id, { featured: !j.featured })} className={"switch " + (j.featured ? "on" : "off")}></div></td>
